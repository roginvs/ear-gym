...
const ru = {
    ...
    loading: "Загрузка",
    noWebAudioError: "Ваш браузер не поддерживает Web Audio API поэтому запустить это приложение невозможно",
    music: "Музыка",
    piano: "Фортепиано",
...
const en: typeof ru = {
    ...
    loading: "Loading",
    noWebAudioError: "You browser does not support Web Audio API, thus it is impossible to run this application",
    music: "Music",
    piano: "Piano",
    drums: "Drum kit",
